...
class BusinessLinkController extends Controller {
 ...
 private function rules():array{return ['link_type'=>['required','string','max:50'],'name'=>['required','string','max:120'],'url'=>['required','url:http,https','max:2048'],'show_on_card'=>['sometimes','boolean'],'display_order'=>['sometimes','integer','min:0'],'is_active'=>['sometimes','boolean']];}
